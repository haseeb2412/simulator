  ...
  return (
    <div style={{display: "flex", alignItems: "center", flexDirection: "column", width: "100%", height: "auto"}}>
        ...
        <div style={{display: "flex", justifyContent: "center", flexWrap: "wrap", width: "90%"}}>
            <h2 style={{textAlign: "center", width: "35%", margin: "10px 0"}}>Muhammad Haseeb</h2>
            <h2 style={{textAlign: "center", width: "35%", margin: "10px 0"}}>Nasr Hussain</h2>
            <h2 style={{textAlign: "center", width: "35%", margin: "10px 0"}}>Ali Mujtaba</h2>
            <h2 style={{textAlign: "center", width: "35%", margin: "10px 0"}}>Umer Khan</h2>
            <h2 style={{textAlign: "center", width: "35%", margin: "10px 0"}}>Syed Yasir</h2>
        </div>
